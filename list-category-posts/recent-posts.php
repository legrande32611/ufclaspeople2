<?php
/*
Plugin Name: List Category Posts - Template "Recent Posts"
Plugin URI: http://picandocodigo.net/programacion/wordpress/list-category-posts-wordpress-plugin-english/
Description: Template file for List Category Post Plugin for Wordpress which is used by plugin by argument template=recent-posts.php
Version: 0.9
...
$lcp_display_output .= '<ul class="lcp_catlist recent-posts">';
...
while ( have_posts() ):
   ...
   */
  $lcp_display_output .= strip_tags( $this->get_excerpt($post, 'div', 'lcp_excerpt'), '<div><a>' );
